...
function RecommendedVideoCard({ 
  ...
  return (
    <a href={`/video/${video.id}`} className="flex-shrink-0 w-64 cursor-pointer group">
      ...
      <div className="mt-2">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-500">{video.views} • {video.time}</p>
      </div>
    </a>
  );
}
...
export default function ClientLayout({ children }: { children: React.ReactNode }) {
  ...
  const RECOMMENDED_VIDEOS = [
    { id: 1, title: 'Eye Makeup Tips for Beginners', thumbnail: 'https://images.unsplash.com/photo-1512496015851-a90fb38ba796?w=400', author: 'Beauty Guru', views: '45K views', time: '3 days ago' },
    { id: 2, title: 'Tricks in making corset', thumbnail: 'https://images.unsplash.com/photo-1558769132-cb1aea9c3d8f?w=400', author: 'Fashion Designer', views: '12K views', time: '1 week ago' },
    { id: 3, title: 'Advanced Styling Techniques', thumbnail: 'https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=400', author: 'Style Master', views: '89K views', time: '2 days ago' },
    { id: 4, title: 'DIY Fashion Hacks', thumbnail: 'https://images.unsplash.com/photo-1483985988355-763728e1935b?w=400', author: 'Creative Lab', views: '23K views', time: '5 days ago' },
    { id: 5, title: 'Seasonal Makeup Trends', thumbnail: 'https://images.unsplash.com/photo-1487412912498-0447578fcca8?w=400', author: 'Trend Setter', views: '67K views', time: '1 day ago' },
  ];
        ...
        <div className="max-w-full mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="/" className="flex items-center gap-3">
              <div className="w-9 h-9 bg-blue-600 rounded-lg flex items-center justify-center text-white font-bold text-lg">C</div>
